import json
def guardarClientes(listaClientes, archivo = "clientes.json"):
    """
    ...
    Parámetros:
        listaClientes (list): lista de diccionarios con la información de los clientes.
        archivo (str): nombre del archivo donde se guardarán los datos.
    """
    try:
        with open(archivo, "w", encoding = "utf-8") as file:
             json.dump(listaClientes, file, indent = 4, ensure_ascii= False)
        print("Datos guardados correctamente.")
    except Exception as e:
        print(f"Error al guardar los datos: {e}")


def cargarClientes(archivo = "clientes.json"):
    """
